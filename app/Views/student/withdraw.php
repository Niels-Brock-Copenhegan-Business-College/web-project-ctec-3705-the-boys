  ...
  <div class="container text-center" style="max-width:480px">
    ...
    <?php elseif (!empty($interest)): ?>
      <div class="alert alert-warning text-start" role="alert">
        ...
        You are about to withdraw your interest for <strong><?= htmlspecialchars((string) ($interest['programme_title'] ?? 'this programme'), ENT_QUOTES) ?></strong>.
        This will remove your registration record.
      </div>
